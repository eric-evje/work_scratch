...
async def sipper_breakin():
    ...
    input("******\nTighten right two screws of motor to resistance. Press Enter when complete ... ")
    ...
    input("******\nTighten right two screws of motor to full torque. Press Enter when complete ... ")
    await fgc.set_sipper_position(50000000, acceleration_nmps = 15000000, speed_nmps = 5000000, deceleration_nmps=15000000)
    input("******\nTighten all motor screws to full torque. Press ENTER when complete ... ")
    input("******\nTighten all brace screws to full torque. Press ENTER when complete ... ")
    await fgc.home_sipper()
    return
...
async def sipper_test():
    ...
    for cycle in range(cycles):
        ...
        await asyncio.sleep(0.25)
        await fgc.set_sipper_position(0, acceleration_nmps = 15000000, speed_nmps = 18000000, deceleration_nmps=15000000)
        await asyncio.sleep(0.25)
    await fgc.home_sipper()
    return
